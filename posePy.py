...
with mp_pose.Pose(min_detection_confidence=0.5,
    ...
    while cap.isOpened():
        ...
        try:
            ...
            # Get coordinates
            pointA = [landmarks[11].x, landmarks[11].y]  #Left Shoulder
            pointB = [landmarks[13].x, landmarks[13].y]  #LEFT_ELBOW
            pointC = [landmarks[15].x, landmarks[15].y]  #LEFT_WRIST
